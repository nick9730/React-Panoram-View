    ...
    <QueryClientProvider client={queryProject}>
     ...
     <Routes>
       <Route element= {
        ...
        <Route index element={<Navigate replace to="/profile" />} ></Route>
        <Route path="/profile" element={<Users/>}></Route>
        <Route path="/projects" element={<ProjectPreview />}></Route>
        <Route path="/projects/:id" element={<Gallery/>}></Route>
        <Route path="/projects/:id/gallery/:id" element={<PanoramaView/>}></Route>
        <Route path="/settings" element={<Settings/>}></Route>
        <Route path="/projects/:id/tour/:id" element={<Tour/>}></Route>
       </Route>
