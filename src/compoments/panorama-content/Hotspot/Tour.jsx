...
export default function Tour() {
    ...
    const {isOpen,setHotspotID,setIndex,setIsOpen,setModalIsOpened,ModalIsOpened} = UseModal()
    ...
    <Pannellum.Hotspot
     cssClass={hotspot.cssClass}  
      ...
      type={'custom'}  
      key={hotspot.id}  
      handleClick={ ()=>{setHotspotID(hotspot.id);setIsOpen(true);setModalIsOpened(true); console.log()
      setIndex(i)} } >
         </Pannellum.Hotspot> 
