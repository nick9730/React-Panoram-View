...
console.log(data)
    ...
    AddHotspot({...data},{onSuccess:()=>onCloseModal?.()})
 }
...
<FormRow label='pitch'>
    <Input type='number'  id='name' {...register('pitch',{
              required:"This field is required"
          })}/>
</FormRow>
<FormRow label='Yaw'>
    <Input type='number'   id='name' {...register('yaw',{
              required:"This field is required"
          })}/>
</FormRow>
<FormRow  label='Info or Custom'>
    <Input disabled type='text'    id='type' {...register('type',{
              required:"This field is required"
          })}/>
</FormRow>
