...
setImagesModalisOpen(false)
  ...
  return(
    <ModelContexet.Provider value={{isOpen,coords,setCoords,mouseCoordinates,yaw,setPitch,setYaw,pitch,setMouseCoordinates ,setIsOpen,close,hotspotID,setHotspotID,ModalIsOpened,setModalIsOpened,index,setIndex,ImagesModalisOpen,setImagesModalisOpen}}>
        {children}
