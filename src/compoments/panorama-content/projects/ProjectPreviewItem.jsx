...
export default function ProjectPreviewItem({project,onCloseModal}) {
 ...
 user_id:user.id
  ...
  return (
   ...
   <ConfirmDuplicate resourceName="project" project={project}   disabled={isCreating} onConfirm={handleSubmit}></ConfirmDuplicate>
   </Modal.Window>

    <Modal.Window id={projectId} name="delete">
     <ConfirmDelete disabled={isDeleting} onConfirm={()=>deletedProject(projectId)}  />
    </Modal.Window>
    </Menus.Menu>
  </Modal> 
